    ...
    return (
        <motion.div>
            <motion.div
                ...
                className="notifications" style={{ position: 'fixed', top: '30px', right: '20px' }}>
                {toasts.map((toast, index) => (
                    ...
                    <motion.div
                        ...
                        key={index} className={`toast ${toast.id}`} style={{ width: '400px', position: 'relative', overflow: 'hidden', listStyle: 'none', borderRadius: '4px', padding: '16px 17px', marginBottom: '10px', background: toast.color, justifyContent: 'space-between', animation: 'show_toast 0.3s ease forwards' }}>
